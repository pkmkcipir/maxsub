...
6. **Export Video** — kalau butuh file video jadi (bukan cuma file
   ...
   - **Burn-in** kalau mau subtitle pasti kelihatan di mana saja tanpa
     ...
     tapi video di-render ulang penuh, jadi butuh waktu.
...
7. **Proses Batch** — untuk banyak video sekaligus tanpa perlu ditunggu
   satu-satu.
