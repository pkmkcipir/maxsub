...
class Translator:
    ...
    def _build_engines(self) -> List[Tuple[str, object]]:
        """Siapkan daftar mesin terjemahan yang dicoba berurutan: Google dulu
        (kualitas biasanya terbaik utk kalimat), lalu MyMemory sbg cadangan
        kalau Google gagal terus (diblokir/limit)."""
