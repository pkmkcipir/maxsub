...
from ..utils.constants import TARGET_LANGUAGES, LANGUAGES


class VideoExportDialog(ctk.CTkToplevel):
    def __init__(self, master, doc, config_manager):
    ...
    def _build(self):
        ...
        self.start_btn = ctk.CTkButton(btn_row, text="Mulai Export", fg_color="#2fa572",
                                        hover_color="#227a54", command=self._start_export)
