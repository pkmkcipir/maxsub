"""Toolbar atas, disusun 2 baris: (1) file & export, (2) proses AI & batch."""
...
class Toolbar(ctk.CTkFrame):
    ...
    def _build(self):
        ...
        self._btn(left, "Export Video...", "export_video", width=130,
                  fg_color="#7a4fc9", hover_color="#5c3a97").pack(side="left", padx=3)
        ...
        self.auto_btn = self._btn(row2, "Proses Otomatis", "auto_process", width=155,
                                   fg_color="#2fa572", hover_color="#227a54",
        ...
        self._btn(row2, "Proses Batch", "batch", width=115).pack(side="left", padx=(16, 3))
