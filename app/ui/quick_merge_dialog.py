...
from ..utils.constants import (
    LANGUAGES, SUPPORTED_VIDEO_EXT, COLOR_SECONDARY, COLOR_SECONDARY_HOVER,
    COLOR_DANGER, COLOR_DANGER_HOVER, COLOR_BG_DARK,
)
...
class QuickMergeDialog(ctk.CTkToplevel):
    ...
    def _build(self):
        ...
        preview_wrapper = ctk.CTkFrame(self.burnin_frame, fg_color=COLOR_BG_DARK, corner_radius=6,
                                        height=140)
        ...
        self.start_btn = ctk.CTkButton(btn_row, text="Mulai Gabung", fg_color=COLOR_SECONDARY,
                                        hover_color=COLOR_SECONDARY_HOVER, command=self._start_merge)
