...
from ..utils.constants import SUPPORTED_VIDEO_EXT, SUPPORTED_AUDIO_EXT, TARGET_LANGUAGES
...
class BatchDialog(ctk.CTkToplevel):
    ...
    def _build(self):
        ...
        self.start_btn = ctk.CTkButton(bottom, text="Mulai Proses", fg_color="#2fa572",
                                        hover_color="#227a54", command=self._start)
        self.start_btn.pack(side="left")
        self.cancel_btn = ctk.CTkButton(bottom, text="Batal", fg_color="#a33", hover_color="#822",
